#!/usr/bin/env python3
"""Scaffold a Windows Electron floating Token BI widget."""
...
TEMPLATE_DIR = SKILL_ROOT / "assets" / "electron-token-bi-template"
...
def copy_template(output: Path, force: bool) -> None:
    ...
    for source in TEMPLATE_DIR.rglob("*"):
        ...
        if any(part in {"node_modules", "diagnostics", ".git"} for part in relative.parts):
            continue
